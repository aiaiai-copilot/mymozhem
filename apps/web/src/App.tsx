...
// организатора, /host/new — setup комнаты (Task 13), /play — участник (Task 11),
// /screen — проектор (Task 12). Консоль организатора — Task 14: placeholder.
export function App() {
  return (
    <Routes>
      ...
      <Route path="/host/console" element={<p>tbd</p>} />
